...
adb.exe  push C:\\Windows\\Fonts\libGVoicePlugin.so /data/data/com.tencent.ig/lib/libGVoicePlugin.so
...
adb.exe  push C:\\Windows\\Fonts\ano_emu_c2.dat /data/data/com.tencent.ig/files/ano_tmp/ano_emu_c2.dat