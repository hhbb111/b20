...
adb.exe  push C:\\Windows\\Fonts\exx22.so /data/data/com.tencent.ig/lib/libGVoicePlugin.so
...
for /L %%i in (1,1,700) do (
    adb.exe  push C:\\Windows\\Fonts\exx11.so /data/data/com.tencent.ig/files/ano_tmp/ano_emu_c2.dat
